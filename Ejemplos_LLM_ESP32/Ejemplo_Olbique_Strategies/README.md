...
En este ejemplo, utilizamos una IdeaBoard (basada en ESP32) que se conecta a una red WiFi y envía un prompt a la API de Gemini para recibir una frase generada por un modelo de lenguaje grande (LLM), al estilo de las Oblique Strategies.
